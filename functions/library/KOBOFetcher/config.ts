...
const envVarsSchema = Joi.object({
  ...
  KOBO_CONNECTION_STRING: Joi.string().allow(''),
  KOBO_CONFIG_FILE_PATH: Joi.string().default('../data/KOBOFetcher_config.yml'),
})
  .unknown()
  .required();
...
const config = {
  ...
  KOBOConnectionString: envVars.KOBO_CONNECTION_STRING,
  KOBOConfigFilePath: envVars.KOBO_CONFIG_FILE_PATH,
};
